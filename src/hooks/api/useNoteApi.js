...
const useNoteApi = () => {
  ...
  const getFavsNotes = () => noteService.getFavsNotes()
  const getSubscribeNotes = () => noteService.getSubscribeNotes()
  const getUnreadNotes = () => noteService.getUnreadNotes()
  const getActiveNotes = () => noteService.getActiveNotes()
